...
This example repository shows how Codecov can be integrated with a simple javascript project. It uses  **Sun\* CI** as CI/CD providers and **jest** as the coverage provider.
